...
*/
let user0 = await users.getUserByName("Mike Scully");
if (user0 === null || !user0)
{
    let usersName = "Mike Scully";
	let passWord  = "UpAllNight";
    let hashedPW  = bcrypt.hashSync(passWord, 10);
	let usersSession = 1; //# do something else
	let createdUser1 = await users.createSimpleUser(usersSession, usersName, hashedPW);
}
/*
